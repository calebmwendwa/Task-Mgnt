    ...
    KanbanBoard.prototype.processCard = function (card) {
        ...
        if (card.meta) {
            ...
            if (card.meta.dueDate) {
                ...
                $cardTags.append("<span class=\"label label-info\" title=\"" + LANG.this_card_has_a_due_date + "\"><i class=\"fas fa-clock\"></i> " + dateStr + "</span>");
            }

            if (card.meta.endDate) {
                var dateStr = moment(card.meta.endDate).format(moment_date_format);
                $cardTags.append("<span class=\"label label-info\" title=\"" + LANG.this_card_has_a_end_date + "\"><i class=\"fas fa-clock\"></i> " + dateStr + "</span>");
            }
