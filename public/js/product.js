...
$(document).ready(function() {
    $(".manage_stock_class").click(function() {
        if($(this).is(":checked")) {
    ...
    $("input#enable_stock").click(function() {
    ...
    /////////////////////////////////////////////
    //If purchase price exc tax is changed
    $(document).on('change', 'input#single_dp', function(e) {
        var purchase = __read_number($('input#single_dp'));
        purchase = purchase == undefined ? 0 : purchase;
        ...
        var profit_percent = __read_number($('#profit_percent2'));
        var selling_price = __add_percent(purchase, profit_percent);
        __write_number($('input#single_ds'), selling_price);
    });

    $(document).on('change', 'input#profit_percent2', function(e) {
        var tax_rate = 0;

        var purchase = __read_number($('input#single_dp'));
        purchase = purchase == undefined ? 0 : purchase;

        var profit_percent = __read_number($('input#profit_percent2'));
        var selling_price = __add_percent(purchase, profit_percent);
        __write_number($('input#single_ds'), selling_price);
    });
    ////////////////////////////////////////////
    ...
    $(document).on('change', 'input#single_dsp', function(e) {
        ...
        if (purchase_exc_tax == 0) {
            purchase_exc_tax = __get_principle(selling_price, profit_percent);
            var purchase_inc_tax = __add_percent(purchase_exc_tax, tax_rate);
            __write_number($('input#single_dpp'), purchase_exc_tax);
            __write_number($('input#single_dpp_inc_tax'), purchase_inc_tax);
        }
