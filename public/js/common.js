   ...
   var icon = "{{ asset('img/icons') }}";
    ...
    var buttons = [
        ...
        // },
        {
            ...
            extend: 'excel',
            text: '<img src="' + icon_url + '/export.svg' + '" alt="" title="'+ LANG.export_to_excel +'" data-toggle="tooltip" data-placement="bottom">',
            exportOptions: {
                columns: ':visible',
            },
            footer: true,
        ...
        {
            extend: 'print',
            text: '<img src="' + icon_url + '/printer.svg' + '" alt="" title="'+ LANG.print +'" data-toggle="tooltip" data-placement="bottom">',
            exportOptions: {
                columns: ':visible',
                stripHtml: true,
            },
    ...
    var pdf_btn = {
        extend: 'pdf',
        text: '<img src="' + icon_url + '/pdf.svg' + '" alt="" title="'+ LANG.export_to_pdf +'" data-toggle="tooltip" data-placement="bottom">',
        exportOptions: {
            columns: ':visible',
        },
        footer: true,
    ...
    jQuery.extend($.fn.dataTable.defaults, {
        ...
        scrollX: true,
        dom:
            '<"row margin-bottom-20 text-center"<"col-sm-2 col-xs-2"l><"col-sm-7 col-xs-6"B><"col-sm-3 col-xs-4"f> r>tip',
        buttons: buttons,
        ...
        language: {
            ...
            processing: '<img src="' + icon_url + '/loader.svg' + '">',
