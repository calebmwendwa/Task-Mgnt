$(document).ready(function() {
    ...
    supplier_report_tbl = $('#supplier_report_tbl').DataTable({
        ...
        fnDrawCallback: function(oSettings) {
            ...
            $('.footer_total_purchase').html(__currency_trans_from_en(total_purchase));

            var total_purchase_return = sum_table_col(
                $('#supplier_report_tbl'),
                'total_purchase_return'
            );
            $('.footer_total_purchase_return').html(__currency_trans_from_en(total_purchase_return));

            var total_sell = sum_table_col($('#supplier_report_tbl'), 'total_invoice');
            $('.footer_total_sell').html(__currency_trans_from_en(total_sell));

            var total_sell_return = sum_table_col($('#supplier_report_tbl'), 'total_sell_return');
            $('.footer_total_sell_return').html(__currency_trans_from_en(total_sell_return));

            var total_opening_bal_due = sum_table_col(
                $('#supplier_report_tbl'),
                'opening_balance_due'
            );
            $('.footer_total_opening_bal_due').html(__currency_trans_from_en(total_opening_bal_due));
    ...
    $('#register_user_id, #register_status, #register_channel').change(function() {
        updateRegisterReport();
    });
    ...
    if ($('#sr_date_filter').length == 1) {
        ...
        sr_sales_report = $('table#sr_sales_report').DataTable({
            ...
            fnDrawCallback: function(oSettings) {
                $('.sr_footer_sale_total').text(
                    __currency_trans_from_en(sum_table_col($('#sr_sales_report'), 'final-total'))
                );

                $('.sr_footer_total_paid').text(__currency_trans_from_en(sum_table_col($('#sr_sales_report'), 'total-paid')));

                $('.sr_footer_total_remaining').text(
                    __currency_trans_from_en(sum_table_col($('#sr_sales_report'), 'payment_due'))
                );
                $('.sr_footer_total_sell_return_due').text(
                    __currency_trans_from_en(sum_table_col($('#sr_sales_report'), 'sell_return_due'))
                );
        ...
        sr_expenses_report = $('table#sr_expenses_report').DataTable({
            ...
            fnDrawCallback: function(oSettings) {
                ...
                $('.footer_expense_total').text(__currency_trans_from_en(expense_total));
        ...
        sr_sales_commission_report = $('table#sr_sales_with_commission_table').DataTable({
            ...
            fnDrawCallback: function(oSettings) {
                $('.footer_sale_total').text(
                    __currency_trans_from_en(sum_table_col($('#sr_sales_with_commission_table'), 'final-total'))
                );

                $('.footer_total_paid').text(
                    __currency_trans_from_en(sum_table_col($('#sr_sales_with_commission_table'), 'total-paid'))
                );

                $('.footer_total_remaining').text(
                    __currency_trans_from_en(sum_table_col($('#sr_sales_with_commission_table'), 'payment_due'))
                );
                $('.footer_total_sell_return_due').text(
                    __currency_trans_from_en(sum_table_col($('#sr_sales_with_commission_table'), 'sell_return_due'))
                );
    ...
    product_sell_report = $('table#product_sell_report_table').DataTable({
        ...
        fnDrawCallback: function(oSettings) {
            $('.footer_subtotal').text(
                __currency_trans_from_en(sum_table_col($('#product_sell_report_table'), 'row_subtotal'))
            );
    ...
    product_sell_grouped_report = $('table#product_sell_grouped_report_table').DataTable({
        ...
        fnDrawCallback: function(oSettings) {
            $('.footer_grouped_subtotal').text(
                __currency_trans_from_en(sum_table_col($('#product_sell_grouped_report_table'), 'row_subtotal'))
            );
    ...
    purchase_payment_report = $('table#purchase_payment_report_table').DataTable({
        ...
        fnDrawCallback: function(oSettings) {
            ...
            $('.footer_total_amount').text(__currency_trans_from_en(total_amount));
        },
    ...
    $('#sell_payment_report_form #location_id, #sell_payment_report_form #customer_id, #sell_payment_report_form #payment_types, #sell_payment_report_form #customer_group_filter, #sell_payment_report_form #user_id').change(
        function() {
            sell_payment_report.ajax.reload();
        }
    );
    ...
    items_report_table = $('#items_report_table').DataTable({
        ...
        fnDrawCallback: function(oSettings) {
            $('.footer_total_pp').html(__currency_trans_from_en(sum_table_col($('#items_report_table'), 'purchase_price')));
            $('.footer_total_sp').html(__currency_trans_from_en(sum_table_col($('#items_report_table'), 'row_selling_price')));
            $('.footer_total_subtotal').html(
                __currency_trans_from_en(sum_table_col($('#items_report_table'), 'row_subtotal'))
            );
    ...
    $('#tax_report_location_id, #tax_report_date_range').change(function() {
        updateTaxReport();
    });
});
